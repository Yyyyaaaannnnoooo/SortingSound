...
<a href="http://blog.benoitvallon.com/sorting-algorithms-in-javascript/sorting-algorithms-in-javascript-all-the-code/">project</a>
`code`
<h2>BUGS</h2>
shell sort<br>
buggy play button, only in safari
